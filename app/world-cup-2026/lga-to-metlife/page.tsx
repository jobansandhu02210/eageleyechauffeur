...
export const metadata: Metadata = {
  title: 'LaGuardia to MetLife Stadium | LGA Car Service',
  description:
    'LaGuardia Airport (LGA) to MetLife Stadium car service — direct transfer ~35 minutes for games, concerts & events. Meet & greet at Terminal B & C, flat-rate, no surge.',
  keywords: [
...
const faqs = [
  { q: 'How long does it take to get from LaGuardia to MetLife Stadium?', a: 'LaGuardia Airport (LGA) to MetLife Stadium is approximately 30–45 minutes by car, depending on traffic. On event days, allow 60 minutes and depart early. Your chauffeur plans the route around live traffic.' },
  { q: 'Is there a direct transfer from LGA to MetLife?', a: 'Yes. Eagle Eye Chauffeur offers direct, no-connection transfers from LGA Terminal B or C to MetLife Stadium. No trains, no buses, no connections — just door-to-door.' },
  ...
  { q: 'Can I go from LGA to my Manhattan hotel first, then to MetLife on event day?', a: 'Yes. Many guests book LGA to a hotel on arrival day, then a separate Manhattan to MetLife transfer on event day. We coordinate both bookings and can assign the same driver.' },
];
    ...
    <>
      ...
      <section className="bg-brand-black text-brand-white py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-brand-silver text-xs font-semibold tracking-widest uppercase mb-4">MetLife Stadium · LaGuardia Airport Transfer</div>
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-semibold leading-tight max-w-4xl mb-6">
            LaGuardia Airport (LGA) to MetLife Stadium — Transfer
          </h1>
      ...
      <section className="bg-brand-black text-white py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-silver text-sm mb-6">Meet &amp; greet · Direct transfer · Flat-rate · No surge</p>
