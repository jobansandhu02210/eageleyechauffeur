...
export const metadata: Metadata = {
  title: 'Newark to MetLife Stadium | EWR Car Service',
  description:
    'Newark Airport (EWR) to MetLife Stadium car service — closest airport to MetLife, just 15 minutes. Flat-rate, meet & greet, no surge. Games, concerts & events.',
  keywords: [
...
const faqs = [
  { q: 'How far is Newark Airport from MetLife Stadium?', a: 'Newark Liberty International Airport (EWR) is approximately 10 miles from MetLife Stadium — the closest major airport. The drive takes 15–25 minutes depending on traffic, making EWR the fastest airport option for MetLife events.' },
  { q: 'Can I go directly from EWR to MetLife Stadium?', a: 'Yes. Eagle Eye Chauffeur offers direct airport-to-stadium transfers. We meet you at arrivals with a name sign, load your luggage, and take you straight to MetLife. No hotel stop required if you are going directly to an event.' },
  { q: 'Should I fly into Newark for a MetLife event?', a: 'If you are choosing between airports specifically for events at MetLife, EWR is the best choice. It is 10 miles from the stadium, compared to 35+ miles for JFK or LGA. The transfer is shorter, cheaper, and faster.' },
  { q: 'What if my flight into Newark is delayed?', a: 'We track your flight in real time. If your flight is delayed, your driver adjusts pickup timing automatically at no extra charge — important when you are connecting for a game or concert.' },
  { q: 'Can you take me from EWR to my hotel first, then to MetLife?', a: 'Yes. Multi-leg bookings are available — EWR to hotel, then hotel to MetLife on event day. Or EWR to MetLife directly if you are heading straight to the stadium.' },
];
    ...
    <>
      ...
      <section className="bg-brand-black text-brand-white py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-brand-silver text-xs font-semibold tracking-widest uppercase mb-4">MetLife Stadium · Closest Airport</div>
          ...
          <p className="text-brand-silver text-lg max-w-2xl leading-relaxed mb-3">
            EWR is the closest major airport to MetLife Stadium — just 10 miles, approximately 15 minutes. The fastest airport-to-stadium transfer for any game, concert, or event. Meet &amp; greet at arrivals, flat-rate pricing, no surge.
          </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { title: 'Direct Airport-to-Stadium', body: 'No connections. No train transfers. No baggage shuttles. We meet you at EWR arrivals with a name sign and take you directly to the MetLife Stadium gate.' },
      ...
      <section className="bg-brand-black text-white py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-silver text-sm mb-6">Meet &amp; greet · Flat-rate · Direct to stadium · No surge</p>
