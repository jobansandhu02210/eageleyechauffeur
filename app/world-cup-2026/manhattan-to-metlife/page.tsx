...
export const metadata: Metadata = {
  title: 'Manhattan to MetLife Stadium | Car Service',
  description:
    'Manhattan to MetLife Stadium car service for games, concerts & events. Flat-rate chauffeur from any hotel or address in Manhattan to MetLife — ~25 minutes.',
  keywords: [
    ...
    'Midtown Manhattan to MetLife car service',
  ],
  alternates: { canonical: `${getSiteUrl()}/world-cup-2026/manhattan-to-metlife` },
};

const faqs = [
  { q: 'How long does it take to drive from Manhattan to MetLife Stadium?', a: 'On a normal day, 20–30 minutes from Midtown Manhattan. On event days, allow 45–60 minutes and plan to arrive early. Your chauffeur will monitor traffic and plan the optimal departure time.' },
  { q: 'What is the best way to get from Manhattan to MetLife?', a: 'Pre-booked private car service is the most reliable option. NJ Transit event trains are crowded and slow to clear afterward, and rideshares surge on game and concert nights. A flat-rate chauffeur from Eagle Eye locks your price at booking and provides door-to-door service from any Manhattan address.' },
  ...
  { q: 'Can I get a post-event pickup from MetLife back to Manhattan?', a: 'Yes — and this is critical on event days. We pre-arrange your post-event pickup point. Your driver waits and contacts you via WhatsApp when you are ready to leave. No rideshare surge on the way back.' },
];
...
export default function ManhattanToMetLifePage() {
  ...
  return (
    <>
      <ServiceJsonLd name="Manhattan to MetLife Stadium Car Service" description="Flat-rate chauffeur from Manhattan to MetLife Stadium for games, concerts, and events. Door-to-door from any Manhattan hotel or address. No surge pricing." areaServed="Manhattan, New York" url={`${siteUrl}/world-cup-2026/manhattan-to-metlife`} />
      <FaqJsonLd faqs={faqs} />
      ...
      <section className="bg-brand-black text-brand-white py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-brand-silver text-xs font-semibold tracking-widest uppercase mb-4">MetLife Stadium · East Rutherford, NJ</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { title: 'No Surge After the Event', body: 'On the return, rideshares surge on big game and concert nights. Your pre-booked Eagle Eye price never changes, regardless of demand.' },
              ...
              { title: 'Event-Day Traffic Planned In', body: 'Your driver factors in stadium traffic and plans departure time so you arrive with time to spare.' },
            ].map((i) => (
      ...
      <section className="bg-brand-black text-white py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-brand-silver text-sm mb-6">Flat-rate · Door-to-door · Post-event pickup · No surge</p>
