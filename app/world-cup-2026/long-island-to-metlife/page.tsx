...
const faqs = [
  { q: 'How long does it take to drive from Long Island to MetLife Stadium?', a: 'From western Nassau County (Garden City, Valley Stream, Elmont): approximately 45–60 minutes. From central Nassau (Great Neck, Manhasset, New Hyde Park): 50–70 minutes. From western Suffolk (Huntington, Babylon): 60–80 minutes. On event days, add 30+ minutes and plan to depart early.' },
  { q: 'Is there a direct car service from Nassau County to MetLife?', a: 'Yes. Eagle Eye Chauffeur picks up from any Nassau County address — Garden City, Great Neck, Manhasset, Mineola, New Hyde Park, Port Washington, Roslyn, Valley Stream, and everywhere in between — and takes you directly to MetLife Stadium.' },
  { q: 'What about Suffolk County pickups?', a: 'Yes. We serve all of Suffolk County including Huntington, Babylon, Smithtown, Hauppauge, and the Hamptons. Longer drives, but the same flat-rate, no-surge pricing applies.' },
  { q: 'Should I drive myself from Long Island to MetLife?', a: 'We generally advise against it for big events. MetLife Stadium parking fills hours before kickoff or showtime and the post-event exit can take 90+ minutes. A pre-booked car service drops you at the gate and picks you up at a pre-arranged spot afterward.' },
  { q: 'Can a group of Long Island fans book together?', a: 'Absolutely. Our Business Class SUVs seat 5–6 and First Class SUVs seat 6–7, with Sprinter vans for larger parties. A group from Long Island sharing one vehicle is cost-effective and stress-free compared to everyone driving separately.' },
];
