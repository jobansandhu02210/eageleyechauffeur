...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/site-map`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.5 },
    ...
    { url: `${base}/world-cup-2026`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/world-cup-2026/manhattan-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/world-cup-2026/newark-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/world-cup-2026/jfk-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/world-cup-2026/lga-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/world-cup-2026/long-island-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/world-cup-2026/nyc-hotel-to-metlife`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/us-open-2026`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${base}/us-open-2026/lga-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/us-open-2026/jfk-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/us-open-2026/ewr-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${base}/us-open-2026/manhattan-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/us-open-2026/long-island-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${base}/us-open-2026/nyc-hotel-to-us-open`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
