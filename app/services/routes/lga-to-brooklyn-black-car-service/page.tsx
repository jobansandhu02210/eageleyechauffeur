...
export const metadata: Metadata = {
  title: 'LGA to Brooklyn Car Service | LaGuardia Black Car | Eagle Eye Chauffeur',
  description:
    'LaGuardia to Brooklyn car service — flat rates, real-time flight tracking, meet & greet at arrivals. Professional TLC-licensed chauffeur, no surge pricing. Book Eagle Eye 24/7.',
...
const comparisonRows = [
  { feature: 'Price', blackCar: 'Flat rate — locked at booking, no surprises', uber: 'Surge pricing — spikes during peak hours' },
    ...
    <>
      ...
      <div className="bg-brand-offwhite">
        ...
        <section className="py-16 lg:py-24">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-brand-grey mb-6">
              Skip the rideshare queue and surge pricing. Eagle Eye Chauffeur provides flat-rate black car
        ...
        <section className="pb-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-serif text-2xl font-semibold text-brand-black mb-6">
              Black Car Service vs. Uber for LGA to Brooklyn
            </h2>
