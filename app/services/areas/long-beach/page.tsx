...
export const metadata: Metadata = {
  title: 'Long Beach Car Service | Black Car & JFK Airport Transfers Nassau | Eagle Eye',
  description:
    'Long Beach NY black car service — flat-rate JFK, LGA & EWR airport transfers from the barrier island city. TLC-licensed chauffeur. No surge pricing. Book Eagle Eye 24/7.',
