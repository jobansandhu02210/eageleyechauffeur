...
export const metadata: Metadata = {
  title: 'Floral Park Car Service | Black Car & JFK Airport Transfers Nassau | Eagle Eye',
  description:
    'Floral Park black car service — flat-rate JFK, LGA & EWR airport transfers from western Nassau County. Stewart Manor & New Hyde Park also covered. No surge pricing. Book Eagle Eye 24/7.',
