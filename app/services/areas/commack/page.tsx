...
export const metadata: Metadata = {
  title: 'Commack Car Service | JFK Transfers Suffolk County',
  description:
...
const faqs = [
  {
    ...
    a: 'Typically 45–60 minutes via the Long Island Expressway (LIE) and Belt Parkway. Commack has direct access to the LIE, and the route westbound to JFK is straightforward.',
  },
  {
    q: 'Do you offer Commack to Manhattan executive car service?',
    a: 'Yes. Daily corporate car service from Commack to Midtown Manhattan and all NYC destinations. Flat rate confirmed at booking, professional chauffeur, door-to-door — a practical alternative to the LIRR.',
  },
  {
    q: 'Do you serve Kings Park and Dix Hills near Commack?',
    a: 'Yes. We cover Commack and all neighboring communities including Kings Park, Dix Hills, East Northport, and Elwood — all under the same flat-rate standard.',
  },
  {
    q: 'Is a flat rate available for all Commack rides?',
    a: 'Yes. Every Eagle Eye booking has a flat rate confirmed at the time of booking. No surge pricing, no metered changes for traffic, weather, or time of day.',
  },
];

const routes = [
  { label: 'Commack to JFK Airport', time: '45–60 min' },
  { label: 'Commack to LaGuardia (LGA)', time: '50–65 min' },
  { label: 'Commack to Newark (EWR)', time: '80–100 min' },
  { label: 'Commack to Manhattan (Midtown)', time: '70–90 min' },
  { label: 'Commack to MacArthur Airport (ISP)', time: '20–30 min' },
  { label: 'Commack to Brooklyn', time: '65–80 min' },
];
  ...
  return (
    <>
      ...
      <ServiceJsonLd
        ...
        description="Premium black car and chauffeur service in Commack, Suffolk County. Flat-rate airport transfers to JFK, LGA, EWR, and MacArthur ISP. Corporate travel and 24/7 availability."
      ...
      <div className="bg-brand-offwhite">
        <section className="py-16 lg:py-24 bg-brand-black text-brand-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-brand-silver max-w-2xl mb-8">
              Black car and chauffeur service in Commack, central Suffolk County. Flat-rate airport transfers to JFK, LGA, EWR, and MacArthur ISP, executive rides into Manhattan, and 24/7 service — no surge pricing.
            </p>
        ...
        <section className="py-16 bg-brand-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-brand-grey mb-6">Estimated travel times from Commack via the LIE. All tolls included. Flat rates confirmed at booking.</p>
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid sm:grid-cols-3 gap-4">
              ...
              <Link href="/services/areas/huntington" className="bg-brand-white border border-brand-light p-5 hover:border-brand-dark transition-colors">
                <div className="font-semibold text-brand-black">Huntington Service</div>
