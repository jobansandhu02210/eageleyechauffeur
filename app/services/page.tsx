...
const services = [
  {
    ...
    slug: 'airport',
    description: 'JFK, LGA, EWR, HPN — meet-and-greet, real-time flight tracking, 60 min free wait. Flat rates, no surge on early or late flights.',
  ...
  },
  {
    ...
    slug: 'corporate',
    description: 'Executive transfers, roadshows, board meetings, and corporate accounts. Discreet, punctual, and professionally trained chauffeurs.',
  ...
  },
  {
    ...
    slug: 'point-to-point',
    description: 'Direct luxury transfers across all 5 boroughs, Long Island, NJ, CT, Westchester, and the Hamptons. Flat rate, door-to-door.',
    image: '/service-point-to-point.png',
    tags: ['Door-to-Door', 'All NYC', 'Long Island'],
  },
  {
  ...
  },
  {
    ...
    slug: 'special-events',
    description: 'Elegant vehicles for weddings, proms, galas, concerts, and milestone celebrations. Multiple vehicles coordinated for wedding parties.',
    image: 'https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=600&q=80',
    tags: ['Weddings', 'Galas', 'Proms'],
  },
];
